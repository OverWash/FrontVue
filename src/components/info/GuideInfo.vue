  ...
  <div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
								...
								<div class="card-body">							
									<div class="col-md-7 mb-6">
										<!-- <div class="embed-responsive embed-responsive-4by3"> -->
											<img src="@/assets/resources/img/booking.svg" class="card-img-top embed-responsive-item" alt="tree">
										<!-- </div> -->
									</div>
									<div class="md-5 mb-6">
					...
					<div class="row">
						<div class="col-xl-12 col-md-12 mb-12">
							<div class="card shadow">
								<div class="card-body">							
									<div class="col-md-7 mb-6">
											<img src="@/assets/resources/img/pickup.svg" class="card-img-top embed-responsive-item" alt="tree">
									</div>
									<div class="md-5 mb-6">
                    ...
                    <p>&nbsp;</p>
										<h6 class="float-right"> 세탁물은 밤 11시까지 문 앞에 두시면 수거합니다. 
										다회용 가방의 경우, 배송 시 돌려드려요.</h6>
                    <p>&nbsp;</p>
					...
					<div class="row">
						<div class="col-xl-12 col-md-12 mb-12">
							<div class="card shadow">
								<div class="card-body">							
									<div class="col-md-7 mb-6">
											<img src="@/assets/resources/img/status_check.svg" class="card-img-top embed-responsive-item" alt="tree">
									</div>
									<div class="md-5 mb-6">
                    ...
                    <p>&nbsp;</p>
										<h6 class="float-right"> 메뉴에서 현황을 확인하실 수 있어요.&nbsp;
										맡긴 세탁물과 요금을 확인 후, 원하는 방식으로 결제해 주세요.</h6>
									</div>
								</div>
							</div>
						</div>
